        ...
        <div className="flex">
          ...
          <div className="flex-1">
            ...
            {activeSection === 1 && (
              <>
                {/* Simple Test Table */}
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Power Plant Portfolio (Test Table)</h3>
                    ...
                    <table className="w-full">
                      ...
                      <tbody>
                        <tr className="border-t border-gray-200 hover:bg-gray-50">
                          <td className="px-4 py-3 text-sm font-medium text-gray-900">Sample Power Plant A</td>
                          <td className="px-4 py-3 text-sm text-gray-600">
                            <span className="inline-flex px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800">
                              Natural Gas
                            </span>
                          </td>
                          <td className="px-4 py-3 text-sm font-semibold text-right text-blue-600">500</td>
                          <td className="px-4 py-3 text-sm text-green-600">Active</td>
                        </tr>
                        <tr className="border-t border-gray-200 hover:bg-gray-50">
                          <td className="px-4 py-3 text-sm font-medium text-gray-900">Sample Power Plant B</td>
                          <td className="px-4 py-3 text-sm text-gray-600">
                            <span className="inline-flex px-2 py-1 text-xs font-medium rounded-full bg-gray-100 text-gray-800">
                              Coal
                            </span>
                          </td>
                          <td className="px-4 py-3 text-sm font-semibold text-right text-blue-600">750</td>
                          <td className="px-4 py-3 text-sm text-green-600">Active</td>
                        </tr>
                        <tr className="border-t border-gray-200 hover:bg-gray-50">
                          <td className="px-4 py-3 text-sm font-medium text-gray-900">Sample Power Plant C</td>
                          <td className="px-4 py-3 text-sm text-gray-600">
                            <span className="inline-flex px-2 py-1 text-xs font-medium rounded-full bg-green-100 text-green-800">
                              Wind
                            </span>
                          </td>
                          <td className="px-4 py-3 text-sm font-semibold text-right text-blue-600">200</td>
                          <td className="px-4 py-3 text-sm text-yellow-600">Maintenance</td>
                        </tr>
                        <tr className="border-t border-gray-200 hover:bg-gray-50">
                          <td className="px-4 py-3 text-sm font-medium text-gray-900">Sample Power Plant D</td>
                          <td className="px-4 py-3 text-sm text-gray-600">
                            <span className="inline-flex px-2 py-1 text-xs font-medium rounded-full bg-yellow-100 text-yellow-800">
                              Solar
                            </span>
                          </td>
                          <td className="px-4 py-3 text-sm font-semibold text-right text-blue-600">100</td>
                          <td className="px-4 py-3 text-sm text-green-600">Active</td>
                        </tr>
                      </tbody>
                    </table>
                ...
                <div className="grid grid-cols-3 gap-4 mb-8">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-lg font-bold text-gray-900">1,550 MW</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex items-center space-x-2 mb-2">
