...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      {/* Modern Header */}
      <header className="bg-slate-900/95 backdrop-blur-sm shadow-lg border-b border-slate-700/50 sticky top-0 z-40">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-6">
              <div className="flex flex-col">
                <h1 className="text-3xl font-bold tracking-tight" style={{ fontFamily: 'system-ui, -apple-system, sans-serif', letterSpacing: '-0.02em', fontWeight: '600' }}>
                  <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">HAYL ENERGY AI</span>
                </h1>
            ...
            <div className="flex items-center space-x-6">
              <nav className="flex items-center space-x-2 text-sm">
                <a href="#" className="px-3 py-2 font-medium text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg transition-all">Home</a>
                <button
                  onClick={() => window.open('/explore', '_blank')}
                  className="px-3 py-2 font-medium text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg transition-all"
                >
                  Explore
                </button>
                <a href="#" className="px-3 py-2 font-medium text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg transition-all">Connections</a>
                <a href="#" className="px-3 py-2 font-medium text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg transition-all">Settings</a>
              </nav>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-slate-700/50 mb-6">
              ...
              <button
                ...
                className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-200 ${
                  region === regionName
                    ...
                    : 'bg-slate-700/50 text-slate-300 hover:bg-slate-700 hover:text-white hover:shadow-md'
                }`}
              >
                {regionName}
              </button>
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 shadow-xl border border-slate-700/50 mb-6 overflow-hidden">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-slate-700/50">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex space-x-2">
                <button className="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white border border-slate-600 rounded-lg hover:bg-slate-700/50">
                  Download
                </button>
                <button className="px-4 py-2 text-sm font-medium text-slate-300 hover:text-white border border-slate-600 rounded-lg hover:bg-slate-700/50">
                  Compare
